...
const SignIn = () => {
 ...
 useEffect(() => {
  scrollToSection('start-form-sign-in')
 }, [])
 ...
 return (
  <>
   ...
   >
    <div
     id='start-form-sign-in'
     className='flex justify-center h-full items-center'
    >
     <div className='w-full'>
      <section className='max-w-xl mx-auto min-h-80 py-10 bg-white rounded-sm'>
       <div>
        <h3 className='text-2xl font-medium text-center'>
         <span className='text-blue-700 mr-2'>ĐĂNG</span>
         <span className='text-orangeCt'>NHẬP</span>
        </h3>
        <div className='mx-auto px-16'>
         ...
         <p className='mt-8 text-center text-orangeCt font-medium'>
          Quên mật khẩu
         </p>
         <div className='mt-8'>
          ...
          <div className='flex justify-center mt-8'>
           <span className='mr-1 text-zinc-600'>Bạn chưa có tài khoản? </span>
